...
const (
	StoreService_GetStore_FullMethodName    = "/grpcs.StoreService/GetStore"
	StoreService_ListStores_FullMethodName  = "/grpcs.StoreService/ListStores"
	StoreService_CreateStore_FullMethodName = "/grpcs.StoreService/CreateStore"
	StoreService_UpdateStore_FullMethodName = "/grpcs.StoreService/UpdateStore"
	StoreService_DeleteStore_FullMethodName = "/grpcs.StoreService/DeleteStore"
)
...
type StoreServiceClient interface {
	GetStore(ctx context.Context, in *GetStoreByIDRequest, opts ...grpc.CallOption) (*GetStoreResponse, error)
...
func (c *storeServiceClient) GetStore(ctx context.Context, in *GetStoreByIDRequest, opts ...grpc.CallOption) (*GetStoreResponse, error) {
...
type StoreServiceServer interface {
	GetStore(context.Context, *GetStoreByIDRequest) (*GetStoreResponse, error)
...
func (UnimplementedStoreServiceServer) GetStore(context.Context, *GetStoreByIDRequest) (*GetStoreResponse, error) {
...
func _StoreService_GetStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoreServiceServer).GetStore(ctx, req.(*GetStoreByIDRequest))
	}
...
var StoreService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "files/grpc-protos/store.proto",
}
